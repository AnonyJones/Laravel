    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <?php if(Route::has('login')): ?>
                ...
                <table>
                    <h1 style="color:white">Welcome to my webproject: Jones Stewart Preciado</h1>
                    <pre>
                    <p style="color:white">Look at the upper right corner!!!</p>
                    </pre>
                </table>
            <?php endif; ?>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\finalwebproj\resources\views/welcome.blade.php ENDPATH**/ ?>